...
# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
mydb = mysql.connector.connect(host="localhost", user="root", password="My@123prad", database="fraud_detection")
...
# Load the model
pipeline = joblib.load('Fraud Detection/fraud_detection_model.pkl')

data = pd.read_csv('Fraud Detection/Cleaned_data.csv')
